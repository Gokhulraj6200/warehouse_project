...
def launch_setup(command, *args, **kwargs):
    ...
    if mode == 'real':
        ...
        rviz_config_dir = os.path.join(get_package_share_directory('cartographer_slam'), 'rviz', 'real_cartographer.rviz')
        use_sim_time = False
    else:
        configuration_basename = 'cartographer.lua'
        rviz_config_dir = os.path.join(get_package_share_directory('cartographer_slam'), 'rviz', 'sim_cartographer.rviz')
        use_sim_time = True
